...
description: Plan and create Assignr task specs from a product brief, feature description, GitHub issue, or engineering goal. Use when the user asks Codex to plan, decompose, break down, or create tasks for a feature or goal — especially before any implementation starts.
---
